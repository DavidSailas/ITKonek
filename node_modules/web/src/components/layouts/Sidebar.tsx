    ...
    <aside className="w-64 h-screen bg-background text-foreground flex flex-col border-r border-lines sticky top-0 transition-colors duration-300">
      <div className="p-6 mb-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-sm font-semibold leading-none font-poppins">{details?.firstName || role}</h1>
            <p className="text-[10px] text-tint font-bold tracking-widest uppercase mt-1">{role} Panel</p>
          </div>
        </div>
      </div>
