        ...
        <div className="relative min-h-svh w-full bg-background text-foreground flex flex-col items-center justify-center p-6 transition-colors duration-300">
            ...
            <div className="relative z-10 w-full max-w-sm">
                <div className="flex flex-col items-center gap-2 mb-4 text-center">
                    ...
                    <div className="flex h-16 w-16 items-center justify-center mb-2 rounded-2xl bg-tint text-white shadow-lg shadow-tint/20 transition-transform hover:scale-105">
